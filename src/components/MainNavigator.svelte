<div class="box has-text-centered columns m-2">
  <a href="/#/dashboard" class="column is-2.5">
    <i class="fas fa-solid fa-water fa-3x" style="color:rgb(153, 196, 74)"></i>
  </a>
  <a href="/#/report" class="column is-2.5">
  ...
  <a href="/#/charts" class="column is-3">
